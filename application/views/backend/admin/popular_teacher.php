			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/student/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo ('Popular Teacher');?></label>
						<div class="col-sm-5">
                        <div class="col-sm-5">
						...
						<textarea name="" id="" cols="63" rows="4" placeholder="Enter Popular Teacher Information"></textarea>
						</div>
					</div>
